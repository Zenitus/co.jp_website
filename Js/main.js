...
document.addEventListener("DOMContentLoaded", () => {
  // Check if the user has a saved preference, otherwise default to 'jp'
  const savedLang = localStorage.getItem("preferredLang") || "jp";
...
// Check if button exists before adding the click event listener
if (mybutton) {
